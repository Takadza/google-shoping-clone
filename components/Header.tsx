...
function Header() {
  ...
  return (
    <div className= "flex flex-col items-center md:flex-row md:items-start md:space-x-6 px-2 pt-10 pb-5 md:p-10 md:pb-5">
        <Link href="/">
        <Image 
         ...
         <div className="w-full md:max-w-2xl">
            ...
            action={(formData) =>{
                ...
                <div className="flex items-center gap-2 w-full px-4">
                    <div className="flex items-center space-x-2 bg-white shadow-xl rounded-full boarder-0 px-6 py-4  flex-1">
                ...
                <div className="grid grid-cols-2 gap-2 p-4 md:grid-cols-4 max-w-lg md:max-w-none mx-auto items-center" >
                    ...
                    {[...Array(100)].map((_, i) =>(
                        <SearchSelectItem key={i} value={(i+1).toString()}>
                            {(i+1).toString()} pages </SearchSelectItem>
                    ))}
                    </SearchSelect>

                   <Select 
                   onValueChange={(value) =>setSortBy}
                   ...
                   className="min-w-4" placeholder="Min Price...">
                    {[", ", "100", "250", "500", "750" , "900", "1000+"].map((_,
                        i) =>(
